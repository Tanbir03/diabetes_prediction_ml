# -*- coding: utf-8 -*-
"""
Created on Wed Jul 10 10:39:21 2024
...
def main():
    ...
    #button creation.
    if st.button('Test'):
        diagnosis = diabetes_prediction([Pregnancies, Glucose, BloodPressure, SkinThikness, Insulin, BMI, DiabetesPedigreeFuction, Age])
